                            ...
                            <section class="article-content clearfix">
                                ...
                                <div class="a-header a-bg rekl">
                                    <div class="container container-bg bg2">
                                        <h1 class="header" style="text-align: center;">Размещение информации (рекламы)
                                            на
                                            Ледовой Арене</h1>
                                        <div class="desc center">
                                            ...
                                            <p>У нас регулярно проходят и <span style="text-decoration: underline;">пользуются большой популярностью</span>
                                                массовые катания,&nbsp;собирая на льду людей всех возрастов и профессий.
                                            </p>
                                            <p>На протяжении всего свободного катания, хоккейных матчей, тренировок&nbsp;и
                                                во
                                                время проведения мастер-классов <strong>люди будут видеть вашу
                                                    рекламу.</strong>
                                            </p>
                                            <p>Информацию можно разместить не только на бортах хоккейной площадки, но и
                                                на
                                                внутренних элементах здания.</p>
                                            <p>Размещение рекламы производится на основании договора оказания услуг.</p>
                                            <p>Дополнительная информация и прием заявок по телефону <a
                                                        href="tel:+78172272423">(8172)
                                                    27-24-23</a></p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row center">
                                            ...
                                            <table class="table price-table" style="max-width: 600px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>500 <i class="fa fa-rub" aria-hidden="true"></i> за 1 пог. метр
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>На внешней стороне бортов (сектор D)</td>
                                                    <td>350 <i class="fa fa-rub" aria-hidden="true"></i> за 1 пог. метр
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>На внутренних элементах здания</td>
                                                    <td>250 <i class="fa fa-rub" aria-hidden="true"></i> за 1 кв. метр
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                                ...
                                                <div class="ba-modal gallery-modal " style="display:none">
                                                    ...
                                                    <div class="ba-modal-header row-fluid"
                                                        ...
                                                        <div class="ba-modal-title"><h3 class="modal-title"
                                                                ...
                                                                Размещение информации (рекламы) - Ледовая арена города
                                                                Арск</h3>
                                                        </div>
                                                        <div class="ba-center-icons"><i
                                                                    style="color:rgba(255, 255, 255, 1)"
                                                            ...
                                                            <div class='span12 ba-gallery-grid css-style-1'>
                                                                <div class='ba-gallery-items category-0 category-1'
                                                                    ...
                                                                    <div class='ba-image'><img
                                                                                data-original='/public/images/bagallery/gallery-9/Razmeshchenie-reklami-4.jpg?1543072550'
                                                                                alt=''>
