...
if(action&&data[action]){data[action]()}})}})(jQuery);(function($){$(document).ready(function(){$('.t3-navbar .t3-megamenu ul li > a').click(function(e){if($(this).hasClass('dropdown-toggle')){window.location.href=$(this).attr('href');}});(function(){$('[data-js="count-up"]').countup();})();});})(jQuery);(function($){$(document).ready(function(){$('.uslugi-menu li.more-usl').click(function(){$(this).toggleClass('active');$(".more-usl ul").fadein();$("li.more-usl ul").fadeIn();})
$('.uslugi-menu a.menu-open').click(function(){$(this).toggleClass('active');$(".uslugi-menu ul").toggleClass('active');})});})(jQuery);